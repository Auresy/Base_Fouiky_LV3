Code de Aurélien Moine et Aurélien Tesnière,
Elaboré à partir d'un canevas de François Caire.
...
- tests_step1 : tests du code tel qu'il devrait être livré pour le premier incrément
- tests_step2 : ajout des tests pour le l'incrément 2
